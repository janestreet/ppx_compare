...
module M3 = struct
  type t = bool [@@deriving compare, equal]
end

module M4 = struct
  type t = int32 [@@deriving compare, equal]
end

module M5 = struct
  type t = nativeint [@@deriving compare, equal]
end

module M6 = struct
  type t = int64 [@@deriving compare, equal]
end
...
module M8 = struct
  type t = bool * float [@@deriving compare, equal]
end

module M9 = struct
  type t = bool * float * int [@@deriving compare, equal]
end

module M10 = struct
  type t = bool * float * int * string [@@deriving compare, equal]
end

module M11 = struct
  type t = int ref [@@deriving compare, equal]
end

module M12 = struct
  type t = (float * float) option [@@deriving compare, equal]
end

module M13 = struct
  type t = float array [@@deriving compare, equal]
end

module M14 = struct
  type t = (int * int) array [@@deriving compare, equal]
end

module M15 = struct
  type t = float array array [@@deriving compare, equal]
end

module M16 = struct
  type t = int list [@@deriving compare, equal]
end
...
module M19 = struct
  type t = Foo [@@deriving compare, equal]
end

module M20 = struct
  type t = Foo of int [@@deriving compare, equal]
end

module M21 = struct
  type t = Foo of int * float [@@deriving compare, equal]
end
...
module M24 = struct
  type t = int * string * [ `Foo | `Bar ] [@@deriving compare, equal]
end
...
module M26 = struct
  type 'a t = 'a array [@@deriving compare, equal]
end
...
module Ignoring_field = struct
  ...
  let equal =
    (fun a__591_ b__592_ ->
       if Stdlib.( == ) a__591_ b__592_
       then true
       else Stdlib.( && ) (equal_int a__591_.b b__592_.b) (equal_int a__591_.c b__592_.c)
            : t -> t -> bool)
  ;;
...
module Ignoring_with_type = struct
  ...
  let compare =
    (fun a__621_ b__622_ ->
       if Stdlib.( == ) a__621_ b__622_
       then 0
       else (
         match compare_int a__621_.a b__622_.a with
         | 0 ->
           let (_ : _) = a__621_.b
           and (_ : _) = b__622_.b in
           0
         | n -> n)
         : t -> t -> int)
  ;;
