...
let compare_int__local : int -> int -> int = compare
let equal_int : int -> int -> bool = ( = )
let equal_int__local : int -> int -> bool = ( = )
...
module Compare_u : sig
  ...
  let _ = fun (_ : u) -> ()
  let compare_u = (compare_int : u -> u -> int)
  let _ = compare_u
...
module Equal_u : sig
  ...
  let _ = fun (_ : u) -> ()
  let equal_u = (equal_int : u -> u -> bool)
  let _ = equal_u
...
module Recursive : sig
  ...
  let rec compare =
    (fun a__017_ b__018_ ->
       ...
       then 0
         ...
         | 0 ->
           compare_u
             (fun a__019_ b__020_ -> compare_int a__019_ b__020_)
             a__017_.u
             b__018_.u
         | n -> n)
     : t -> t -> int)
  ...
  and compare_u : 'a. ('a -> 'a -> int) -> 'a u -> 'a u -> int =
    ...
    then 0
      ...
      | 0 ->
        compare_v
          (fun a__023_ b__024_ -> compare_int a__023_ b__024_)
          (fun a__025_ b__026_ -> _cmp__a a__025_ b__026_)
          a__021_.v
          b__022_.v
      | n -> n)
