...
module Inline = struct
  ...
  let compare_mut__local : 'a. ('a -> 'a -> int) -> 'a mut -> 'a mut -> int =
  ...
  let equal_mut__local : 'a. ('a -> 'a -> bool) -> 'a mut -> 'a mut -> bool =
