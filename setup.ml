(* OASIS_START *)
(* DO NOT EDIT (digest: cbc83150664d81df70e74d8bcfb22fed) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_compare";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_compare_expander"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ppx_compare";
                      lib_findlib_name = Some "expander";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_core", None);
                           FindlibPackage ("ppx_driver", None);
                           InternalLibrary "ppx_compare_expander";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "|+z\141\241\000\127\207\184\175d]\2117?U";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
